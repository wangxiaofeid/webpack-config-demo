...
import { Form, Row, Col, Input, Select, Button, Table, Icon, Spin, DatePicker } from 'antd'
import Edit from "./edit";
import { fun1, fun2 } from "../../utils/tools";
...
@Form.create()
class DemoSearchForm extends React.Component{
  onSubmit = e => {
    e.preventDefault();
